...
public interface EventService {
    ...
    List<EventFullDto> getEventsBySearch(List<Integer> userIds, List<String> states, List<Integer> categories, LocalDateTime rangeStart, LocalDateTime rangeEnd, Integer from, Integer size);

    List<ParticipationRequestDto> getRequestInEvent(Integer userId, Integer eventId);

    EventRequestStatusUpdateResult requestStatusUpdate(Integer userId, Integer eventId, EventRequestStatusUpdateRequest statusUpdateRequest);

    List<EventFullDto> getEventsFiltered(String text, List<Integer> categories, Boolean paid, LocalDateTime rangeStart, LocalDateTime rangeEnd, Boolean onlyAvailable, String sort, Integer from, Integer size);
